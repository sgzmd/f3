...
export class SearchRequest extends jspb.Message {
  ...
  setEntryTypeFilter(value: EntryType): void;
...
export class FoundEntry extends jspb.Message {
  ...
  setNumEntities(value: number): void;
...
export class SearchResponse extends jspb.Message {
  ...
  setOriginalRequest(value?: SearchRequest): void;

  clearEntryList(): void;
  getEntryList(): Array<FoundEntry>;
  setEntryList(value: Array<FoundEntry>): void;
...
export class TrackedEntry extends jspb.Message {
  ...
  setNumEntries(value: number): void;
...
export class UpdateRequired extends jspb.Message {
  ...
  setTrackedEntry(value?: TrackedEntry): void;

  getNewNumEntries(): number;
  setNewNumEntries(value: number): void;

  clearNewBookList(): void;
  getNewBookList(): Array<Book>;
  setNewBookList(value: Array<Book>): void;
...
export class UpdateCheckRequest extends jspb.Message {
  ...
  setTrackedEntryList(value: Array<TrackedEntry>): void;
...
export class UpdateCheckResponse extends jspb.Message {
  ...
  setUpdateRequiredList(value: Array<UpdateRequired>): void;
...
export class EntityName extends jspb.Message {
  ...
  setAuthorName(value?: AuthorName): void;
...
export class TrackedEntryKey extends jspb.Message {
  ...
  setEntityType(value: EntryType): void;
...
export class TrackEntryResponse extends jspb.Message {
  ...
  setKey(value?: TrackedEntryKey): void;

  getResult(): TrackEntryResult;
  setResult(value: TrackEntryResult): void;
...
export class ListTrackedEntriesResponse extends jspb.Message {
  ...
  setEntryList(value: Array<TrackedEntry>): void;
...
export class UntrackEntryResponse extends jspb.Message {
  ...
  setResult(value: UntrackEntryResult): void;
